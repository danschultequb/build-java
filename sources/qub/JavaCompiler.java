...
public interface JavaCompiler
{
     ...
     * @param sourceFolder The folder that contains all of the source files to compile.
     ...
     */
    Result<JavaCompilationResult> compile(Iterable<File> sourceFiles, Folder sourceFolder, Folder outputFolder, String javaVersion, Console console);
}
