        ...
        runner.testGroup(FakeJavaCompiler.class, () ->
        {
            ...
            runner.testGroup("compile()", () ->
            {
                runner.test("with null sourceFiles", (Test test) ->
                {
                    ...
                    final Folder sourceFolder = fileSystem.getFolder("/sources").throwErrorOrGetValue();
                    final Folder outputFolder = fileSystem.getFolder("/outputs").throwErrorOrGetValue();

                    final FakeJavaCompiler compiler = new FakeJavaCompiler();
                    test.assertThrows(() -> compiler.compile(sourceFiles, sourceFolder, outputFolder, "1.8", new Console()), new PreConditionFailure("sourceFiles cannot be null."));
                });
                ...
                runner.test("with empty sourceFiles", (Test test) ->
                {
                    ...
                    final FakeJavaCompiler compiler = new FakeJavaCompiler();
                    test.assertThrows(() -> compiler.compile(sourceFiles, sourceFolder, outputFolder, "1.8", new Console()), new PreConditionFailure("sourceFiles cannot be empty."));
                });
                ...
                runner.test("with null outputFolder", (Test test) ->
                {
                    ...
                    final FakeJavaCompiler compiler = new FakeJavaCompiler();
                    test.assertThrows(() -> compiler.compile(sourceFiles, sourceFolder, outputFolder, "1.8", new Console()), new PreConditionFailure("outputFolder cannot be null."));
                });
                ...
                runner.test("with null console", (Test test) ->
                {
                    ...
                    final FakeJavaCompiler compiler = new FakeJavaCompiler();
                    test.assertThrows(() -> compiler.compile(sourceFiles, sourceFolder, outputFolder, "8", null), new PreConditionFailure("console cannot be null."));
                });
                ...
                runner.test("with null javaVersion", (Test test) ->
                {
                    ...
                    final FakeJavaCompiler compiler = new FakeJavaCompiler();
                    final JavaCompilationResult result = compiler.compile(sourceFiles, sourceFolder, outputFolder, null, new Console()).throwErrorOrGetValue();
                ...
                runner.test("with empty javaVersion", (Test test) ->
                {
                    ...
                    final FakeJavaCompiler compiler = new FakeJavaCompiler();
                    final JavaCompilationResult result = compiler.compile(sourceFiles, sourceFolder, outputFolder, "", new Console()).throwErrorOrGetValue();
                    test.assertNotNull(result);
                    test.assertEqual(0, result.getExitCode());
                    test.assertSuccess(true, fileSystem.getFile("/outputs/a/B.class").thenResult(File::exists));
                });
                ...
                runner.test("with \"1.8\" javaVersion", (Test test) ->
                {
                    ...
                    final FakeJavaCompiler compiler = new FakeJavaCompiler();
                    final JavaCompilationResult result = compiler.compile(sourceFiles, sourceFolder, outputFolder, "1.8", new Console()).throwErrorOrGetValue();
                    test.assertNotNull(result);
                    test.assertEqual(0, result.getExitCode());
                    test.assertSuccess(true, fileSystem.getFile("/outputs/a/B.class").thenResult(File::exists));
                });
